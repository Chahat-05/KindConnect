...
export const ProductsCard = ({ productId,
    productName,
    productImage,
    productDescription,
    price,
    ...
    const [formData, setFormData] = useState({
        username: username,
        amount: price*splitRatio/100,
        category: "second hand sales",
        date: today,
    ...
    const buttonClick = async (e) => {
        ...
        try {
            ...
            const postResponse = await fetch(`/api/buyProduct`, {
                method: "POST",
                headers: {
            ...
            // Now send the DELETE request to delete the product
            const deleteResponse = await fetch(`/api/deleteProduct/${productId}`, {
                method: "DELETE",
                headers: {
                    "Content-Type": "application/json",
                },
            ...
            if (deleteResponse.ok) {
                ...
                console.log(`Error deleting product: ${deleteData.message}`);
            }
    ...
    return (
        <div className="productcard">
            ...
            <div className="card-footer">
                ...
                <div className="card-button" onClick={buttonClick}>
